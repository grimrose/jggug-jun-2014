...
environments {
    ...
    prod {
        ...
        url = 'http://grimrose.github.io/jggug-jun-2014' // site URL, for example http://www.example.com
...
gh_pages_url = 'git@github.com:grimrose/jggug-jun-2014.git' // path to GitHub repository in format git@github.com:{username}/{repo}.git
